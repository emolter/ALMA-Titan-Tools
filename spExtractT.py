...
imgname="Titan_HC3N.clean.image"
outfile="Spectrum.txt"
CHAN=1920 #Channel to use for generating the threshold mask
...
write2col(freqspec/1e9,Kfactor*np.asarray(spectrum),outfile)
